...
const RUST_THRESHOLDS: Record<string, number> = {
  ...
  // Ranking badges - rust after 14 days (maintained by check-ranking-badges)
  TOP_1_WEEKLY_VOLUME: 14,
  TOP_5_WEEKLY_VOLUME: 14,
  TOP_10_WEEKLY_VOLUME: 14,
  TOP_25_WEEKLY_VOLUME: 14,
  TOP_1_WEEKLY_WORKOUTS: 14,
  TOP_5_WEEKLY_WORKOUTS: 14,
  TOP_10_WEEKLY_WORKOUTS: 14,
  TOP_25_WEEKLY_WORKOUTS: 14,
  TOP_1_MONTHLY_XP: 14,
  TOP_5_MONTHLY_XP: 14,
  TOP_10_MONTHLY_XP: 14,
  TOP_25_MONTHLY_XP: 14,
  TOP_1_MONTHLY_PRS: 14,
  TOP_5_MONTHLY_PRS: 14,
  TOP_10_MONTHLY_PRS: 14,
  TOP_25_MONTHLY_PRS: 14,
  TOP_1_ALL_TIME_XP: 14,
  TOP_5_ALL_TIME_XP: 14,
  TOP_10_ALL_TIME_XP: 14,
  TOP_25_ALL_TIME_XP: 14,
  TOP_1_ALL_TIME_WORKOUTS: 14,
  TOP_5_ALL_TIME_WORKOUTS: 14,
  TOP_10_ALL_TIME_WORKOUTS: 14,
  TOP_25_ALL_TIME_WORKOUTS: 14,
