...
Deno.serve(async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    // SECURITY: Rate limiting to prevent rapid polling and DoS
    ...
    const rateLimit = await checkRateLimit(
      user.id,
      'sync-pull',
      RATE_LIMITS['sync-pull'].maxRequests,
      RATE_LIMITS['sync-pull'].windowMs,
      supabaseAdmin
    );
      ...
      return new Response(
        ...
        }),
        {
          ...
          headers: {
            ...
            "X-RateLimit-Limit": RATE_LIMITS['sync-pull'].maxRequests.toString(),
