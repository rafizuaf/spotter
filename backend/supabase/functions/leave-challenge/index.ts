...
Deno.serve(async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    // SECURITY: Rate limiting to prevent leave spam
    ...
    const rateLimit = await checkRateLimit(
      user.id,
      'leave-challenge',
      RATE_LIMITS['leave-challenge'].maxRequests,
      RATE_LIMITS['leave-challenge'].windowMs,
      supabaseAdmin
    );
      ...
      return new Response(
        ...
        }),
        {
          ...
          headers: {
            ...
            "X-RateLimit-Limit": RATE_LIMITS['leave-challenge'].maxRequests.toString(),
